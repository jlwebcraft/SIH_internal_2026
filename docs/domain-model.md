...
The Phase 3B operational domain model is implemented as JPA entities and a PostgreSQL Flyway migration.
...
- No prediction, risk scoring, recommendation, simulation, alert, authentication, Firebase, or ML entities are implemented in Phase 3B.
